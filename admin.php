  ...
  <div id="myCarousel<?php if($i!=1)echo $i;?>" class="carousel slide" data-ride="carousel<?php if($i!=1)echo $i;?>">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <div id="abc"><a href="imagecategory.php?Category=About & city=<?php echo$cityname;?>"><img id="abc"src="uploads/MumbaiAbout.jpg" alt="Chania"></a><h2 class="c1" style="width: 100%;"><span>About &nbsp; <?php echo $cityname;  ?></span></h2></div>
    ...
    <div id="abc"><a href="imagecategory.php?Category=package & city=<?php echo$cityname;?>"><img id="abc"src="<?php echo $packageimage;?>" alt="Chania"></a><h2 class="c1" ><span>Packages</span></h2></div>
        ...
        <div id="abc"><a href="imagecategory.php?Category=knowmore&city=<?php echo$cityname;?>"><img id="abc"src="uploads/KnowMore.png" alt="Chania"></a><h2 class="c3"><span>Know More..</span></h2></div>
      </div>
